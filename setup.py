...
setup(
    ...
    long_description='This packages is designed to help interface with the Workfront API. It builds on the original'
                     '"sample" API class available from Workfront and adds features such as making an update on behalf'
                     'of another user, support for lists in parameters.',
